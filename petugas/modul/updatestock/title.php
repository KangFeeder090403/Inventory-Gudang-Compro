...
<body>
            ...
            <div class="row mt-3">
                <div class="col-md-8 offset-md-2">
                    <form action="" method="POST" class="d-flex justify-content-start align-items-center">
                        ...
                        <!-- Input tanggal -->
                        <input type="date" id="cari_tanggal" name="cari_tanggal"
                            value="<?php echo isset($_POST['cari_tanggal']) ? $_POST['cari_tanggal'] : date('Y-m-d'); ?>"
                            class="form-control me-2"
                            style="font-size:16px; padding:8px; width:150px; text-align:right;">


                        <button type="submit" name="go_tanggal" class="btn btn-success me-2">
    ...
    <script>
        function exportToExcel() {
            ...
            header += "<img src='logo.jpg' style='width:100px; float:right; margin-bottom:10px;'>";
