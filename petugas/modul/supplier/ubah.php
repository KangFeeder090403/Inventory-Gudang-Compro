...
<head>
  ...
  <title>Edit Master Supplier</title>
  ...
  <div id="wrapper">
    ...
    <form action="?m=supplier&s=update" method="POST" enctype="multipart/form-data">
      <div id="page-wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h1 class="page-header">Edit Master Supplier</h1>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="exampleInputEmail1" value="<?php echo $r['cp_sup']; ?>"
            name="cp_sup" aria-describedby="emailHelp" placeholder="Masukkan Contact Person">
