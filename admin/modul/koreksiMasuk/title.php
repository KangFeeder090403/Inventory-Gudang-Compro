...
<body>
  ...
  <div id="wrapper">
    ...
    <div id="page-wrapper">
      <div class="row">
        <div class="col-lg-12">
          <h1 class="page-header">Return (Awal)</h1>
        </div>
      </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLongTitle">Tambah Return (Masuk)</h5>
              ...
              <form action="?m=koreksiMasuk&s=simpan" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                  ...
                  <input type="text" name="kode_transaksi" id="kode_transaksi" class="form-control"
                    placeholder="Masukkan Kode Return (Awal)" required>
                </div>
      ...
      <div class="row">
        <center>
          <form action="" method="POST">
            <label>Cari Return (Awal) (Kode / Nama)</label>
        ...
        <div class="print-header-content">
          <div class="print-header-left">
            <h2 class="print-header-title">
              <i class="fa fa-download print-header-icon"></i>
              LAPORAN RETURN (AWAL)
            </h2>
          </div>
        </div>
  ...
  <script>
    $(document).ready(function() {
        setTimeout(function() {
            $('#side-menu a[href*="koreksiMasuk"]').addClass('active');
        }, 100);
    });
  </script>
