...
<head>
  ...
  <title>Transaksi Koreksi Barang Masuk</title>
...
<body>
  ...
  <div id="wrapper">
          ...
          <ul class="nav" id="side-menu">
            ...
            <li>
              <a href="?m=barang&s=awal">
                <i class="fa fa-archive"></i> Detail Barang
              </a>
            </li>
            ...
            <li>
              <a href="?m=koreksiMasuk&s=awal">
                <i class="fa fa-plus-square"></i> Detail Return Awal
              </a>
            </li>

            <li>
              <a href="?m=koreksiKeluar&s=awal">
                <i class="fa fa-minus-square"></i> Detail Return Akhir
              </a>
            </li>
    ...
    <div id="page-wrapper">
      <div class="row">
        <div class="col-lg-12">
          <h1 class="page-header">Transaksi Koreksi Barang Masuk</h1>
        </div>
      </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLongTitle">Tambah Transaksi Koreksi Barang Masuk</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
              <form action="?m=koreksiMasuk&s=simpan" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                  <label for="kode_transaksi">Kode Transaksi</label>
                  <input type="text" name="kode_transaksi" id="kode_transaksi" class="form-control"
                    placeholder="Masukkan Kode Transaksi Koreksi Barang Masuk" required>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputEmail1" name="masuk"
                    aria-describedby="emailHelp" placeholder="Masukkan Masuk">
                  <small id="emailHelp" class="form-text text-muted">Masukkan Masuk</small>
                </div>
                ...
                <div class="form-group">
                  ...
                  $queryCus = "SELECT * FROM tb_cus ORDER BY kode_cus ASC";
                  $resultCus = mysqli_query($koneksi, $queryCus);

                  $jsCustomer = "var prdCustomer = {};\n";

                  echo '<select name="kode_cus" onchange="changeCustomer(this.value)" class="form-control">';
                  echo '<option value="">--- PILIH ---</option>';

                  while ($row = mysqli_fetch_array($resultCus)) {
                    echo '<option value="' . $row['kode_cus'] . '">' . $row['kode_cus'] . ' | ' . $row['nama_cus'] . '</option>';
                    $jsCustomer .= "prdCustomer['" . $row['kode_cus'] . "'] = {
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="nama_cus" readonly id="prd_cus" class="form-control">
                </div>
                ...
                <div class="form-group">
                  <label for="exampleInputEmail1">No. Plat Truck</label>
                  <input type="text" class="form-control" id="exampleInputEmail1" name="truck"
                    aria-describedby="emailHelp" placeholder="Masukkan No. Plat Truck">
                  <small id="emailHelp" class="form-text text-muted">Masukkan No. Plat Truck</small>
                </div>
      ...
      <div class="row">
        <center>
          <form action="" method="POST">
            <label>Cari Koreksi Masuk (Kode / Nama)</label>
            <input type="text" name="cari_koreksiMasuk">
            <button type="submit" name="go_koreksiMasuk" class="btn btn-success">Cari</button>
          </form>
        </center>
      </div>
            ...
            <ul class="pagination justify-content-center">
              <li class="page-item">
                <a class="page-link" <?php if ($halaman > 1) {
                  echo "href='?m=koreksiMasuk&s=awal&halaman=$previous'";
                } ?>>Previous</a>
              </li>
              <?php
              for ($x = 1; $x <= $total_halaman; $x++) {
                ...
                <li class="page-item"><a class="page-link"
                    href="?m=koreksiMasuk&s=awal&halaman=<?php echo $x ?>"><?php echo $x; ?></a></li>
                <?php
              }
              ?>
              <li class="page-item">
                <a class="page-link" <?php if ($halaman < $total_halaman) {
                  echo "href='?m=koreksiMasuk&s=awal&halaman=$next'";
                } ?>>Next</a>
              </li>
            </ul>
          </center>
