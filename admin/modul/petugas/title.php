...
<body>
  ...
  <div id="wrapper">
    ...
    <div id="page-wrapper">
      <div class="row">
        <div class="col-lg-12">
          <h1 class="page-header">Master Petugas</h1>
        </div>
      </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLongTitle">Tambah Master Petugas</h5>
            ...
            <div class="modal-body">
              <form action="?m=petugas&s=simpan" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <small id="emailHelp" class="form-text text-muted">Masukkan Job Disk Petugas</small>
                </div>
                <div class="form-group">
