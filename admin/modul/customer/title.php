...
<body>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="?m=customer&s=simpan" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                  <label for="exampleInputEmail1">Kode Customer</label>
                  <input type="text" class="form-control" id="exampleInputEmail1" name="kode_cus" maxlength="15"
                    aria-describedby="emailHelp" placeholder="Masukkan Kode Customer">
                  <small id="emailHelp" class="form-text text-muted">Masukkan Kode Customer</small>
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Nama Customer</label>
                  <input type="text" class="form-control" id="exampleInputEmail1" name="nama_cus"
                    aria-describedby="emailHelp" placeholder="Masukkan Nama Customer">
                  <small id="emailHelp" class="form-text text-muted">Masukkan Nama Customer</small>
                </div>
                <div class="form-group">
                  <label>Email Customer</label>
                  <input type="text" class="form-control" id="exampleInputEmail1" name="email_cus"
                    aria-describedby="emailHelp" placeholder="Masukkan Email Customer">
                  <small class="form-text text-muted">Masukkan Email Customer</small>
                </div>
                <div class="form-group">
                  <label>Alamat Customer</label>
                  <textarea class="form-control" aria-describedby="emailHelp" name="alamat_cus"
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputEmail1" name="cp_cus"
                    aria-describedby="emailHelp" placeholder="Masukkan Kontak Customer">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputEmail1" name="telepon_cus"
                    aria-describedby="emailHelp" placeholder="Masukkan Telepon Customer">
      ...
      <div class="row">
        <center>
          <form action="" method="POST">
            <label>Cari Customer (Kode / Nama)</label>
            <input type="text" name="cari_customer">
            <button type="submit" name="go_customer" class="btn btn-success">Cari</button>
          </form>
        </center>
      </div>
            ...
            <ul class="pagination justify-content-center">
              <li class="page-item">
                <a class="page-link" <?php if ($halaman > 1) {
                  echo "href='?m=customer&s=awal&halaman=$previous'";
                } ?>>Previous</a>
              </li>
              <?php
              for ($x = 1; $x <= $total_halaman; $x++) {
                ...
                <li class="page-item"><a class="page-link"
                    href="?m=customer&s=awal&halaman=<?php echo $x ?>"><?php echo $x; ?></a></li>
                <?php
              }
              ?>
              <li class="page-item">
                <a class="page-link" <?php if ($halaman < $total_halaman) {
                  echo "href='?m=customer&s=awal&halaman=$next'";
                } ?>>Next</a>
              </li>
            </ul>
          </center>
  ...
  <!-- Fallback script untuk memastikan highlight -->
  <script>
    $(document).ready(function() {
        // Tunggu sebentar untuk memastikan DOM ready
        setTimeout(function() {
            // Pastikan customer menu aktif
            $('#side-menu a[href*="customer"]').addClass('active');
            console.log('Customer menu highlighted via fallback');
        }, 100);
    });
  </script>
