        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLongTitle">Tambah Saldo Awal</h5>
              ...
              <form action="?m=saldoawal&s=simpan" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputEmail1" name="saldoawal"
                    aria-describedby="emailHelp" placeholder="Masukkan Saldo Awal">
                  <small id="emailHelp" class="form-text text-muted">Masukkan Saldo Awal</small>
                </div>
                <div class="form-group">
