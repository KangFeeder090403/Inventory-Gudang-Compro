...
<body>
      ...
      <div class="row">
        <center>
          <form action="" method="POST">
            <label>Cari Barang Masuk (Kode / Nama)</label>
            <input type="text" name="cari_barangMasuk">
            <button type="submit" name="go_barangMasuk" class="btn btn-success">Cari</button>
          </form>
        </center>
      </div>
        ...
        <div class="print-header-content">
          <div class="print-header-left">
            ...
            <div class="print-info">
              Tanggal Cetak: <?php echo date('d/m/Y, h:i A'); ?>
            </div>
          </div>
        </div>
      </div>
            ...
            <ul class="pagination justify-content-center">
              ...
              for ($x = 1; $x <= $total_halaman; $x++) {
                ...
                <li class="page-item"><a class="page-link"
                    href="?m=barangMasuk&s=awal&halaman=<?php echo $x ?>"><?php echo $x; ?></a></li>
                <?php
              }
              ?>
              <li class="page-item">
  ...
  <script>
    $(document).ready(function() {
        setTimeout(function() {
            $('#side-menu a[href*="barangMasuk"]').addClass('active');
        }, 100);
    });
  </script>
