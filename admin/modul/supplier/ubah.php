      ...
      <div id="page-wrapper">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="exampleInputEmail1" name="nama_sup"
            value="<?php echo $r['nama_sup']; ?>" aria-describedby="emailHelp" placeholder="Masukkan Nama Supplier">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="exampleInputEmail1" name="email_sup" aria-describedby="emailHelp"
            placeholder="Masukkan Email Supplier" value="<?php echo $r['email_sup']; ?>">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" aria-describedby="emailHelp" value="<?php echo $r['alamat_sup']; ?>"
            name="alamat_sup" placeholder="Masukkan Alamat Supplier">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="exampleInputEmail1" value="<?php echo $r['telepon_sup']; ?>"
            name="telepon_sup" aria-describedby="emailHelp" placeholder="Masukkan Telepon Supplier">
