          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="?m=kondisi&s=simpan" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <label for="exampleInputEmail1">Nama Kondisi Barang</label>
                  <input type="text" class="form-control" id="exampleInputEmail1" name="nama_kondisi"
                    aria-describedby="emailHelp" placeholder="Masukkan Nama Kondisi Barang">
                  <small id="emailHelp" class="form-text text-muted">Masukkan Nama Kondisi Barang</small>
                </div>
