...
<head>
  ...
  <title>Edit Kondisi Barang</title>
...
<body>
  ...
  <div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
      ...
      include '../koneksi.php';
      $sql = "SELECT * FROM tb_kondisi WHERE kode_kondisi = '$id'";
    ...
    <div id="page-wrapper">
      <div class="row">
        <div class="col-lg-12">
          <h1 class="page-header">Edit Kondisi Barang</h1>
        </div>
      </div>

      <div class="row">

        <form action="?m=kondisi&s=update" method="POST" enctype="multipart/form-data">
          <input type="hidden" name="kode_kondisi_lama" value="<?php echo $r['kode_kondisi']; ?>">
          
          <div class="form-group">
            <label for="kode_kondisi">Kode Kondisi Barang</label>
            <input type="text" class="form-control" id="kode_kondisi" name="kode_kondisi"
              value="<?php echo $r['kode_kondisi']; ?>" aria-describedby="kodeHelp"
              placeholder="Masukkan Kode Kondisi Barang" required>
            <small id="kodeHelp" class="form-text text-muted">Masukkan Kode Kondisi Barang</small>
          </div>
          
          <div class="form-group">
            <label for="nama_kondisi">Kondisi Barang</label>
            <input type="text" class="form-control" value="<?php echo $r['nama_kondisi']; ?>" id="nama_kondisi"
              name="nama_kondisi" aria-describedby="namaHelp" placeholder="Masukkan Kondisi Barang" required>
            <small id="namaHelp" class="form-text text-muted">Masukkan Kondisi Barang</small>
          </div>

          <div class="form-group text-right">
            <a href="?m=kondisi&s=awal" class="btn btn-secondary">Close</a>
