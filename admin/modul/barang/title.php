        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLongTitle">Tambah Master Barang</h5>
            ...
            <div class="modal-body">
              <form action="?m=barang&s=simpan" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputEmail1" name="kode_brg" maxlength="15"
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputEmail1" name="isi_satuan"
                    aria-describedby="emailHelp" placeholder="Masukkan Isi Satuan">
                  <small id="emailHelp" class="form-text text-muted">Masukkan Isi Satuan</small>
                </div>
