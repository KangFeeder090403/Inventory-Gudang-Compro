...
while ($row = mysqli_fetch_array($data_karyawan)) {
    ...
    <tr>
        ...
        <td><a href="index.php?m=admin&s=hapus&kode_admin=<?php echo $row['kode_admin']; ?>"
                onclick="return confirm('Yakin Akan Dihapus?')"><button class="btn btn-danger">Hapus</button></a> |
            <a href="index.php?m=admin&s=ubah&kode_admin=<?php echo $row['kode_admin']; ?>">
