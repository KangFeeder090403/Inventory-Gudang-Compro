    ...
    <div id="page-wrapper">
      ...
      <div class="row">
        ...
        <form action="?m=admin&s=update" method="POST" enctype="multipart/form-data">
          <input type="hidden" name="kode_admin" value="<?php echo $r['kode_admin']; ?>">
          
          <div class="form-group">
            <label for="username">Username</label>
            <input type="text" class="form-control" id="username" name="username"
              value="<?php echo $r['username']; ?>" aria-describedby="usernameHelp"
          ...
          <div class="form-group">
            ...
            <input type="password" class="form-control" id="password" name="password"
              aria-describedby="passwordHelp" placeholder="Kosongkan jika tidak ingin mengubah password">
            <small id="passwordHelp" class="form-text text-muted">Kosongkan jika tidak ingin mengubah password</small>
          </div>
          
          <div class="form-group">
            <label for="nama">Nama</label>
            <input type="text" class="form-control" value="<?php echo $r['nama']; ?>" id="nama"
              name="nama" aria-describedby="namaHelp" placeholder="Masukkan Nama">
            <small id="namaHelp" class="form-text text-muted">Masukkan Nama Lengkap</small>
          </div>
          
          <div class="form-group">
            <label for="telepon">Telepon</label>
            <input type="text" class="form-control" value="<?php echo $r['telepon']; ?>" id="telepon"
              name="telepon" aria-describedby="teleponHelp" placeholder="Masukkan Nomor Telepon">
            <small id="teleponHelp" class="form-text text-muted">Masukkan Nomor Telepon</small>
          </div>

          <div class="form-group text-right">
            <a href="?m=admin&s=awal" class="btn btn-secondary">Close</a>
