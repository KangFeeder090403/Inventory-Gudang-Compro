...
<body>
      ...
      <div class="row">
        <center>
          <form action="" method="POST">
            <label>Cari Barang Keluar (Kode / Nama)</label>
            <input type="text" name="cari_barangKeluar">
            <button type="submit" name="go_barangKeluar" class="btn btn-success">Cari</button>
          </form>
        </center>
      </div>
            ...
            <ul class="pagination justify-content-center">
              ...
              for ($x = 1; $x <= $total_halaman; $x++) {
                ...
                <li class="page-item"><a class="page-link"
                    href="?m=barangKeluar&s=awal&halaman=<?php echo $x ?>"><?php echo $x; ?></a></li>
                <?php
              }
              ?>
              <li class="page-item">
  ...
  <script>
    $(document).ready(function() {
        setTimeout(function() {
            $('#side-menu a[href*="barangKeluar"]').addClass('active');
        }, 100);
    });
  </script>
