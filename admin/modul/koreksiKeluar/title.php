...
<body>
  ...
  <div id="wrapper">
    ...
    <div id="page-wrapper">
      <div class="row">
        <div class="col-lg-12">
          <h1 class="page-header">Return (Akhir)</h1>
        </div>
      </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLongTitle">Tambah Return (Akhir)</h5>
              ...
              <form action="?m=koreksiKeluar&s=simpan" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                  ...
                  <input type="text" name="kode_transaksi" id="kode_transaksi" class="form-control"
                    placeholder="Masukkan Kode Return (Akhir)" required>
                </div>
      ...
      <div class="row">
        <center>
          <form action="" method="POST">
            <label>Cari Return (Akhir) (Kode / Nama)</label>
  ...
  <script>
    $(document).ready(function() {
        setTimeout(function() {
            $('#side-menu a[href*="koreksiKeluar"]').addClass('active');
        }, 100);
    });
  </script>
