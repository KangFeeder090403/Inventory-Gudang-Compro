...
<body>
  ...
  <div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
      ...
      include '../koneksi.php';
      $sql = "SELECT * FROM tb_koreksi_out WHERE kode_transaksi = '$id'";
    ...
    <form action="?m=koreksiKeluar&s=update" method="POST" enctype="multipart/form-data">
      <div id="page-wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h1 class="page-header">Edit Return Akhir</h1>
          </div>
        </div>
...
<div class="form-group">
  ...
  <div class="form-group text-right">
    <a href="?m=koreksiKeluar&s=awal" class="btn btn-secondary">Close</a>
