...
<head>
  ...
  <title>Edit Rak Penyimpanan</title>
...
<body>
  ...
  <div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
      ...
      $id = $_GET['kode_rak'];
      include '../koneksi.php';
      $sql = "SELECT * FROM tb_rak WHERE kode_rak = '$id'";
    ...
    <div id="page-wrapper">
      <div class="row">
        <div class="col-lg-12">
          <h1 class="page-header">Edit Rak Penyimpanan</h1>
        </div>
      </div>

      <div class="row">

        <form action="?m=rak&s=update" method="POST" enctype="multipart/form-data">
          <input type="hidden" name="kode_rak_lama" value="<?php echo $r['kode_rak']; ?>">
          
          <div class="form-group">
            <label for="kode_rak">Kode Rak Penyimpanan</label>
            <input type="text" class="form-control" id="kode_rak" name="kode_rak"
              value="<?php echo $r['kode_rak']; ?>" aria-describedby="kodeHelp"
              placeholder="Masukkan Kode Rak Penyimpanan" required>
            <small id="kodeHelp" class="form-text text-muted">Masukkan Kode Rak Penyimpanan</small>
          </div>
          
          <div class="form-group">
            <label for="nama_rak">Lokasi Rak Penyimpanan</label>
            <input type="text" class="form-control" value="<?php echo $r['nama_rak']; ?>" id="nama_rak"
              name="nama_rak" aria-describedby="namaHelp" placeholder="Masukkan Lokasi Rak Penyimpanan" required>
            <small id="namaHelp" class="form-text text-muted">Masukkan Lokasi Rak Penyimpanan</small>
          </div>

          <div class="form-group text-right">
            <a href="?m=rak&s=awal" class="btn btn-secondary">Close</a>
