...
<body>
  ...
  <div id="wrapper">
    ...
    <div id="page-wrapper">
      <div class="row">
        <div class="col-lg-12">
          <h1 class="page-header">Rak Penyimpanan</h1>
        </div>
      </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLongTitle">Tambah Rak Penyimpanan</h5>
            ...
            <div class="modal-body">
              <form action="?m=rak&s=simpan" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                  <label for="exampleInputEmail1">Kode Rak Penyimpanan</label>
                  <input type="text" class="form-control" id="exampleInputEmail1" name="kode_rak"
                    aria-describedby="emailHelp" placeholder="Masukkan Kode Rak Penyimpanan">
                  <small id="emailHelp" class="form-text text-muted">Masukkan Kode Rak Penyimpanan</small>
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Lokasi Rak Penyimpanan</label>
                  <input type="text" class="form-control" id="exampleInputEmail1" name="nama_rak"
                    aria-describedby="emailHelp" placeholder="Masukkan Rak Penyimpanan">
                  <small id="emailHelp" class="form-text text-muted">Masukkan Rak Penyimpanan</small>
                </div>
      ...
      <div class="row">
        <center>
          <form action="" method="POST">
            <label>Cari Rak (Kode / Nama)</label>
            <input type="text" name="cari_rak">
            <button type="submit" name="go_rak" class="btn btn-success">Cari</button>
          </form>
        </center>
      </div>
            ...
            <ul class="pagination justify-content-center">
              <li class="page-item">
                <a class="page-link" <?php if ($halaman > 1) {
                  echo "href='?m=rak&s=awal&halaman=$previous'";
                } ?>>Previous</a>
              </li>
              <?php
              for ($x = 1; $x <= $total_halaman; $x++) {
                ...
                <li class="page-item"><a class="page-link"
                    href="?m=rak&s=awal&halaman=<?php echo $x ?>"><?php echo $x; ?></a></li>
                <?php
              }
              ?>
              <li class="page-item">
                <a class="page-link" <?php if ($halaman < $total_halaman) {
                  echo "href='?m=rak&s=awal&halaman=$next'";
                } ?>>Next</a>
              </li>
            </ul>
          </center>
  ...
  <script>
    $(document).ready(function() {
        setTimeout(function() {
            $('#side-menu a[href*="rak"]').addClass('active');
        }, 100);
    });
  </script>
