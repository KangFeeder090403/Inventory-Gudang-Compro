              ...
              <form action="?m=rak&s=simpan" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputEmail1" name="kode_rak"
                    aria-describedby="emailHelp" placeholder="Masukkan Kode Rak">
                  <small id="emailHelp" class="form-text text-muted">Masukkan Kode Rak</small>
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Nama Rak</label>
                  <input type="text" class="form-control" id="exampleInputEmail1" name="nama_rak"
                    aria-describedby="emailHelp" placeholder="Masukkan Nama Rak">
